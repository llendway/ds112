...
This tutorial introduces the `ggplot2` and `dplyr` packages, which are part of the `tidyverse`. It is broken into two sections, the first focuses on plotting with `ggplot()` and the second focuses an using the 6 main `dplyr` verbs or functions.
